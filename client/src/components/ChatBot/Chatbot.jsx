...
const steps = [
  ...
  },
  {
    id: "html",
    message:
      "HTML (HyperText Markup Language) is the standard markup language for creating web pages and other information to be displayed in a web browser.",
    trigger: "more",
  },
  {
    id: "javascript",
    message:
      "JavaScript is a high-level, interpreted programming language that conforms to the ECMAScript specification. It is used primarily for client-side scripting and creating dynamic web content.",
    trigger: "more",
  },
  {
    id: "more",
