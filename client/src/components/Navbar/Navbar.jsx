  ...
  return (
    <nav className="main-nav">
      <div className="navbar">
        ...
        {User === null ? (
          <Link to="/Auth" className="nav-item nav-links nav2">
            Log in
          </Link>
        ) : (
          <>
            ...
            <button className="nav-item nav-links nav2" onClick={handleLogout}>
              Log out
            </button>
          </>
        )}
