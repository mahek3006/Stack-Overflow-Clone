...
const UserProfile = () => {
  ...
  const currentuserProfile = users.filter(
  ...
  useEffect(() => {
    if (currentProfile && currentuserProfile) {
      const isFriend = currentuserProfile.addFriend.includes(
        currentProfile._id
      );
            ...
            <div className="user-details">
              ...
              <div className="user-name">
                ...
                <p>
                  ...
                  {moment(currentProfile?.joindOn).fromNow()}
                </p>
                ...
                {currentUser !== null && (
                  <>
                    {isFriend ? (
                      <button
                        type="button"
                        className="edit-profile-btn remove-frd"
                      ...
                      <button
                        type="button"
                        className="edit-profile-btn add-frd"
