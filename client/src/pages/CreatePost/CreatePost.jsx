  ...
  const handleSubmit = (e) => {
    ...
    if (User === null) {
      ...
      if (postBody === "") {
        ...
        data.append("upload_preset", "stackoverflow-hm");
        data.append("cloud_name", "stackoverflow-hm");
        ...
        const cloudinaryEndpoint = isImage
          ? "https://api.cloudinary.com/v1_1/stackoverflow-hm/image/upload"
          : "https://api.cloudinary.com/v1_1/stackoverflow-hm/video/upload";
        ...
        <form className="post-form" onSubmit={handleSubmit}>
          ...
          <div className="box-input">
            <div className="image-upload">
              <label htmlFor="file_image" title="Select Photo">
            ...
            <div className="image-upload">
              <label htmlFor="file_video" title="Select Video">
          ...
          {photo &&
            (photo.type.startsWith("image/") ? (
              <p className="mediaType">Photo Selected</p>
            ) : (
              <p className="mediaType">Video Selected</p>
            ))}
        </form>
      </div>
    </div>
